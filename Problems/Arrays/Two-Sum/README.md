...
This directory contains an implementation of the "Two Sum" problem in C#. It uses a `Dictionary<TKey, TValue>` to find two numbers in an array that add up to a given target value and maintains a temporal complexity of `O(n)`.
