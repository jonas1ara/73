...
This directory contains an implementation of the "Longest Palindromic Substring" problem in C#. The implementation uses Manacher's algorithm to find the longest palindromic substring in linear time `O(n)`.
