...
- Es un lenguaje de alto nivel, pero no tanto como Python, asi que si vienes de a ver visto C en la escuela, será muy Baja entender la sintaxis básica de C# y una vez que lo escribas también podrás entender lenguajes de muy alto nivel como Python o F#
...
|---| ----- | -------- | ---------- |
|0001|[Two Sum](https://leetcode.com/problems/two-sum/) | [C#]()|Baja|
|0011|[Container With Most Water](https://leetcode.com/problems/container-with-most-water/) | [C#]()|Media|
|0015|[3Sum](https://leetcode.com/problems/3sum/) | [C#]()|Media|
|0033|[Search in Rotated Sorted Array](https://leetcode.com/problems/search-in-rotated-sorted-array/) | [C#]()|Media|
|0053|[Maximum Subarray](https://leetcode.com/problems/maximum-subarray/) | [C#]()|Media|
|0121|[Best Time to Buy and Sell Stock](https://leetcode.com/problems/best-time-to-buy-and-sell-stock/) | [C#]()|Media|
|0152|[Maximum Product Subarray](https://leetcode.com/problems/maximum-product-subarray/) | [C#]()|Media|
|0153|[Find Minimum in Rotated Sorted Array](https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/) | [C#]()|Media|
|0217|[Contains Duplicate](https://leetcode.com/problems/find-minimum-in-rotated-sorted-array/) | [C#]()|Baja|
|0238|[Product of Array Except Self](https://leetcode.com/problems/product-of-array-except-self/) | [C#]()|Baja|
...
| # | Titulo | Solución | Dificultad |
|---| ----- | -------- | ---------- |
|0019|[Remove Nth Node From End of List](https://leetcode.com/problems/remove-nth-node-from-end-of-list/) | [C#]()|Media|
|0021|[Merge Two Sorted Lists](https://leetcode.com/problems/merge-two-sorted-lists/) | [C#]()|Baja|
|0023|[Merge k Sorted Lists](https://leetcode.com/problems/merge-k-sorted-lists/) | [C#]()|Alta|
|0141|[Linked List Cycle](https://leetcode.com/problems/linked-list-cycle/) | [C#]()|Baja|
|0143|[Reorder List](https://leetcode.com/problems/reorder-list/) | [C#]()|Media|
|0206|[Reverse Linked List](https://leetcode.com/problems/reverse-linked-list/) | [C#]()|Baja|

### Árboles

| # | Titulo | Solución | Dificultad |
|---| ----- | -------- | ---------- |
|0098|[Validate Binary Search Tree](https://leetcode.com/problems/validate-binary-search-tree/) | [C#]()|Media|
|0100|[Same Tree](https://leetcode.com/problems/same-tree/) | [C#]()|Baja|
|0102|[Binary Tree Level Order Traversal](https://leetcode.com/problems/binary-tree-level-order-traversal/) | [C#]()|Media|
|0104|[Maximum Depth of Binary Tree](https://leetcode.com/problems/maximum-depth-of-binary-tree/) | [C#]()|Baja|
|0105|[Construct Binary Tree from Preorder and Inorder Traversal](https://leetcode.com/problems/construct-binary-tree-from-preorder-and-inorder-traversal/) | [C#]()|Media|
|0124|[Binary Tree Maximum Path Sum](https://leetcode.com/problems/binary-tree-maximum-path-sum/) | [C#]()|Alta|
|0208|[Implement Trie (Prefix Tree)](https://leetcode.com/problems/implement-trie-prefix-tree/) | [C#]()|Media|
|0211|[Design Add and Search Words Data Structure](https://leetcode.com/problems/design-add-and-search-words-data-structure/) | [C#]()|Media|
|0212|[Word Search II](https://leetcode.com/problems/word-search-ii/) | [C#]()|Alta|
|0226|[Invert Binary Tree](https://leetcode.com/problems/invert-binary-tree/) | [C#]()|Alta|
|0230|[Kth Smallest Element in a BST](https://leetcode.com/problems/kth-smallest-element-in-a-bst/) | [C#]()|Media|
|0235|[Lowest Common Ancestor of a Binary Search Tree](https://leetcode.com/problems/lowest-common-ancestor-of-a-binary-search-tree/) | [C#]()|Media|
|0207|[Serialize and Deserialize Binary Tree](https://leetcode.com/problems/serialize-and-deserialize-binary-tree/) | [C#]()|Alta|
|0572|[Subtree of Another Tree](https://leetcode.com/problems/subtree-of-another-tree/) | [C#]()|Baja|
